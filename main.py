...
from database import Session, Character  # предполагается, что база реализована отдельно

# Состояния для диалога создания персонажа
ENTER_NAME, CHOOSE_RACE, CHOOSE_CLASS, ENTER_STATS = range(4)
...
async def receive_name(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    races = ["Человек", "Эльф", "Дварф", "Полурослик", "Драконорожденный"]
